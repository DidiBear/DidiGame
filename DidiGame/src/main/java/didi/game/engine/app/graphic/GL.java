package disopy.game.engine.app.graphic;
...
public final class GL {
	...
	public static void drawQuad(Color color, Quad surface){
		drawQuad(color, surface.getPosition(), surface.getWidth(), surface.getHeight());
	}
	...
	private static void drawTexture(Texture texture, Quad surface, Color filter){
		...
		GL11.glBegin(GL11.GL_QUADS);
		    ...
		    GL11.glVertex2f(x + surface.getWidth(), y + surface.getHeight());
		 
		    GL11.glTexCoord2f(0, texture.getHeight());
		    GL11.glVertex2f(x, y + surface.getHeight());
		GL11.glEnd();
	}
